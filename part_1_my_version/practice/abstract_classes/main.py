...
class Transport(ABC):
    ...
    @property
    def name(self):
        return self.__transport_name__
...
class Boat(Transport):
    ...
    def start_engine(self):
        print(f'Двигатель {self.name} запущен')

    def stop_engine(self):
        print(f'Двигатель {self.name} остановлен')
...
class Electroscooter(Transport):
    __transport_name__ = 'Электроскутер'
